...
pub mod pallet {
    ...
    use prediction_market_primitives::{orderbook::OrderId, types::Asset};
    use sp_avn_common::{verify_signature, InnerCallValidator, Proof};
    use sp_runtime::traits::{Dispatchable, IdentifyAccount, SaturatedConversion, Verify};

    pub const BUY: &[u8] = b"buy outcome tokens";
    pub const SELL: &[u8] = b"sell outcome tokens";

    #[pallet::config]
    pub trait Config: frame_system::Config + pallet_pm_hybrid_router::Config {
    ...
    impl<T: Config> Pallet<T> {
        /// Routes a signed buy order through the hybrid-router pallet.
        #[pallet::call_index(0)]
        ...
        pub fn signed_buy(
            ...
            pallet_pm_hybrid_router::Pallet::<T>::buy(
        ...
        /// Routes a signed sell order through the hybrid-router pallet.
        #[pallet::call_index(1)]
        ...
        pub fn signed_sell(
            ...
            pallet_pm_hybrid_router::Pallet::<T>::sell(
                frame_system::RawOrigin::Signed(who.clone()).into(),
                market_id.clone(),
                asset_count,
                asset,

...
fn top_up_rejects_already_funded_period() {
    ...
    ext.execute_with(|| {
        ...
        assert_noop!(
            NodeManager::top_up_reward_pot(RawOrigin::Root.into(), 0, PRD),
...
fn top_up_rejects_legitimately_zero_funded_period() {
    ...
    ext.execute_with(|| {
        ...
        assert_noop!(
            NodeManager::top_up_reward_pot(RawOrigin::Root.into(), 3, PRD),
            Error::<TestRuntime>::RewardPotAlreadyFunded
        );
    });
}
...
fn top_up_rejects_unknown_period() {
    ...
    ext.execute_with(|| {
        ...
        assert_noop!(
            NodeManager::top_up_reward_pot(RawOrigin::Root.into(), 7, PRD),
...
fn top_up_rejects_non_root_origin() {
    ...
    ext.execute_with(|| {
        ...
        assert_noop!(
            NodeManager::top_up_reward_pot(RuntimeOrigin::signed(signed), 0, PRD,),

...
//! Autogenerated weights for pallet_pm_authorized
//!
...
// --steps=50
// --repeat=20
// --pallet=pallet_pm_authorized
// --extrinsic=*
// --wasm-execution=compiled
// --heap-pages=4096
// --template=./misc/weight_template.hbs
// --header=./HEADER_GPL3
// --output=./pallets/authorized/src/weights.rs
...
/// pallet_pm_authorized (automatically generated)
...
/// Weight functions for pallet_pm_authorized (automatically generated)
...
impl<T: frame_system::Config> WeightInfoZeitgeist for WeightInfo<T> {
    ...
    /// Some(1042), added: 3517, mode: `MaxEncodedLen`) The range of component `m` is `[1, 63]`.
    fn authorize_market_outcome_first_report(m: u32) -> Weight {

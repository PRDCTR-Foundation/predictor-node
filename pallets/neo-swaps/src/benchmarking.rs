...
use prediction_market_primitives::{
    ...
    traits::{
        CombinatorialTokensFuel, CompleteSetOperationsApi, FutarchyOracle, PalletAdminGetter,
    },
...
#[benchmarks(where T: frame_system::Config)]
mod benchmarks {
    use super::*;
    ...
    fn set_early_exit_fee_account() {
        let market_admin =
            T::PalletAdminGetter::get_admin().expect("market admin should be configured");

...
//! Autogenerated weights for pallet_pm_neo_swaps
//!
...
// --steps=50
// --repeat=20
// --pallet=pallet_pm_neo_swaps
// --extrinsic=*
// --wasm-execution=compiled
// --heap-pages=4096
// --template=./misc/weight_template.hbs
// --header=./HEADER_GPL3
// --output=./pallets/neo-swaps/src/weights.rs
...
/// pallet_pm_neo_swaps (automatically generated)
...
impl<T: frame_system::Config> WeightInfoZeitgeist for WeightInfo<T> {
    ...
    /// `MaxEncodedLen`) Storage: `MarketCommons::Markets` (r:1 w:0)
    /// Proof: `MarketCommons::Markets` (`max_values`: None, `max_size`: Some(708), added: 3183,
    /// mode: `MaxEncodedLen`) Storage: `Tokens::Accounts` (r:129 w:129)
    /// Proof: `Tokens::Accounts` (`max_values`: None, `max_size`: Some(137), added: 2612, mode:
    /// `MaxEncodedLen`) Storage: `System::Account` (r:3 w:3)
    /// Proof: `System::Account` (`max_values`: None, `max_size`: Some(132), added: 2607, mode:
    /// `MaxEncodedLen`) Storage: `Tokens::TotalIssuance` (r:128 w:128)
    /// Proof: `Tokens::TotalIssuance` (`max_values`: None, `max_size`: Some(57), added: 2532, mode:
    ...
    /// `MaxEncodedLen`) Storage: `MarketCommons::Markets` (r:1 w:0)
    /// Proof: `MarketCommons::Markets` (`max_values`: None, `max_size`: Some(708), added: 3183,
    /// mode: `MaxEncodedLen`) Storage: `Tokens::Accounts` (r:256 w:256)
    /// Proof: `Tokens::Accounts` (`max_values`: None, `max_size`: Some(137), added: 2612, mode:
    ...
    /// Proof: `MarketCommons::Markets` (`max_values`: None, `max_size`: Some(708), added: 3183,
    /// mode: `MaxEncodedLen`) Storage: `NeoSwaps::MarketIdToPoolId` (r:1 w:1)
    /// Proof: `NeoSwaps::MarketIdToPoolId` (`max_values`: None, `max_size`: Some(40), added: 2515,
    /// mode: `MaxEncodedLen`) Storage: `NeoSwaps::PoolCount` (r:1 w:1)
    /// Proof: `NeoSwaps::PoolCount` (`max_values`: Some(1), `max_size`: Some(16), added: 511, mode:
    /// `MaxEncodedLen`) Storage: `Tokens::Accounts` (r:256 w:256)
    /// Proof: `Tokens::Accounts` (`max_values`: None, `max_size`: Some(137), added: 2612, mode:
    /// `MaxEncodedLen`) Storage: `System::Account` (r:1 w:1)
    /// Proof: `System::Account` (`max_values`: None, `max_size`: Some(132), added: 2607, mode:
    /// `MaxEncodedLen`) Storage: `NeoSwaps::Pools` (r:0 w:1)
    /// Proof: `NeoSwaps::Pools` (`max_values`: None, `max_size`: Some(152829), added: 155304, mode:
    /// `MaxEncodedLen`) The range of component `n` is `[2, 128]`.
    fn deploy_pool(n: u32) -> Weight {
        // Proof Size summary in bytes:
    ...
    /// Storage: `NeoSwaps::Pools` (r:1 w:1)
    /// Proof: `NeoSwaps::Pools` (`max_values`: None, `max_size`: Some(152829), added: 155304, mode:
    /// `MaxEncodedLen`) Storage: `MarketCommons::Markets` (r:7 w:0)
    /// Proof: `MarketCommons::Markets` (`max_values`: None, `max_size`: Some(708), added: 3183,
    /// mode: `MaxEncodedLen`) Storage: `System::Account` (r:3 w:3)
    /// Proof: `System::Account` (`max_values`: None, `max_size`: Some(132), added: 2607, mode:
    /// `MaxEncodedLen`) Storage: `Tokens::Accounts` (r:256 w:256)
    ...
    /// `MaxEncodedLen`) Storage: `Tokens::TotalIssuance` (r:128 w:128)
    /// Proof: `Tokens::TotalIssuance` (`max_values`: None, `max_size`: Some(57), added: 2532, mode:
    /// `MaxEncodedLen`) The range of component `n` is `[1, 7]`.
    fn combo_buy(n: u32) -> Weight {
        // Proof Size summary in bytes:
        //  Measured:  `0 + n * (2782 ±0)`
    ...
    /// `MaxEncodedLen`) Storage: `MarketCommons::Markets` (r:7 w:0)
    /// Proof: `MarketCommons::Markets` (`max_values`: None, `max_size`: Some(708), added: 3183,
    /// mode: `MaxEncodedLen`) Storage: `Tokens::Accounts` (r:255 w:255)
    /// Proof: `Tokens::Accounts` (`max_values`: None, `max_size`: Some(137), added: 2612, mode:
    /// `MaxEncodedLen`) Storage: `System::Account` (r:3 w:3)
    /// Proof: `System::Account` (`max_values`: None, `max_size`: Some(132), added: 2607, mode:
    /// `MaxEncodedLen`) Storage: `Tokens::TotalIssuance` (r:128 w:128)
    ...
    /// Proof: `System::Account` (`max_values`: None, `max_size`: Some(132), added: 2607, mode:
    /// `MaxEncodedLen`) Storage: `Tokens::Accounts` (r:382 w:382)
    /// Proof: `Tokens::Accounts` (`max_values`: None, `max_size`: Some(137), added: 2612, mode:
    /// `MaxEncodedLen`) Storage: `Tokens::TotalIssuance` (r:254 w:254)
    /// Proof: `Tokens::TotalIssuance` (`max_values`: None, `max_size`: Some(57), added: 2532, mode:
    /// `MaxEncodedLen`) Storage: `NeoSwaps::PoolCount` (r:1 w:1)
    /// Proof: `NeoSwaps::PoolCount` (`max_values`: Some(1), `max_size`: Some(16), added: 511, mode:
    /// `MaxEncodedLen`) Storage: `NeoSwaps::Pools` (r:0 w:1)
    /// Proof: `NeoSwaps::Pools` (`max_values`: None, `max_size`: Some(152829), added: 155304, mode:
    /// `MaxEncodedLen`) The range of component `n` is `[1, 7]`.
